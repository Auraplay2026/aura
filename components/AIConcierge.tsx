...
export function AIConcierge() {
  ...
  return (
    <div className={`fixed ${isCasinoGame ? "bottom-24 right-4" : "bottom-[204px] right-4 md:bottom-6 md:right-36"} z-[42] flex flex-col items-end gap-4 transition-all duration-300 pointer-events-none`}>
      <AnimatePresence>
        {isOpen && (
          <motion.div
