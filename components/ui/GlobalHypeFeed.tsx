      ...
      <AnimatePresence mode="popLayout">
        {currentMessage && (
          <motion.div
            ...
            className={`pointer-events-auto backdrop-blur-xl border rounded-[20px] p-4 shadow-2xl max-w-sm w-full mb-3 cursor-pointer hover:scale-105 transition-transform duration-300 ${currentMessage.color}`}
          >
