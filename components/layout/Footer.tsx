        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              <button className="text-slate-500 hover:text-red-600 transition-colors"><MessageCircle className="w-5 h-5" /></button>
              <button className="text-slate-500 hover:text-red-600 transition-colors"><Globe className="w-5 h-5" /></button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/casino/slots" className="hover:text-red-600 transition-colors">Slots</Link></li>
              <li><Link href="/casino/live" className="hover:text-red-600 transition-colors">Live Casino</Link></li>
              <li><Link href="/casino/originals" className="hover:text-red-600 transition-colors">Originals</Link></li>
              <li><Link href="/casino/rtp" className="hover:text-red-600 transition-colors">Live RTP</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/sportsbook" className="hover:text-red-600 transition-colors">Live Sports</Link></li>
              <li><Link href="/sportsbook/soccer" className="hover:text-red-600 transition-colors">Soccer</Link></li>
              <li><Link href="/sportsbook/esports" className="hover:text-red-600 transition-colors">Esports</Link></li>
              <li><Link href="/predictions/politics" className="hover:text-red-600 transition-colors">Predictions</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/rg" className="hover:text-red-600 transition-colors">Responsible Gaming</Link></li>
              ...
              <li><Link href="/support" className="hover:text-red-600 transition-colors flex items-center gap-2"><MessageSquare className="w-4 h-4" /> Live Support</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/vip" className="hover:text-red-600 transition-colors">VIP Club</Link></li>
              <li><Link href="/affiliate" className="hover:text-red-600 transition-colors">Affiliates</Link></li>
              <li><Link href="/promotions" className="hover:text-red-600 transition-colors">Giveaways</Link></li>
              <li><Link href="/tournaments" className="hover:text-red-600 transition-colors">Races</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              {["Pragmatic Play", "Evolution", "Hacksaw", "Nolimit City"].map((provider) => (
                <div key={provider} className="bg-slate-50 border border-slate-200 px-5 py-3 rounded-2xl shadow-sm font-black text-sm md:text-base tracking-tighter text-slate-600 hover:text-slate-900 hover:border-red-300 hover:shadow-md cursor-pointer transition-all duration-300 transform hover:-translate-y-1">
