  ...
  return (
    <div className={`w-full h-full min-h-[500px] bg-gradient-to-br ${feltColor} rounded-[3rem] border-[24px] border-[#291715] shadow-[inset_0_0_100px_rgba(0,0,0,0.95),_inset_0_0_0_2px_rgba(245,158,11,0.2),_0_20px_50px_rgba(0,0,0,0.7)] relative flex flex-col items-center justify-center overflow-hidden`}>
      ...
      <div className="relative z-10 w-full flex flex-col items-center gap-6 mt-16 px-6">
        ...
        {isPlaying && (
          <div className="bg-white/50 border border-slate-200 backdrop-blur-md px-4 py-1.5 rounded-full text-[10px] font-black uppercase text-yellow-400 tracking-wider">
        ...
        {isBlackjack || isBaccarat ? (
          <div className="flex flex-col md:flex-row gap-12 w-full justify-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              {dealerHand.length > 0 && (
                <span className="text-slate-900 font-mono font-bold text-xs bg-white/45 px-3 py-1 rounded-full border border-slate-200">
                  Score: {dealerScore}
                </span>
              )}
            </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            {playerHand.length === 5 && (
              <span className="text-yellow-400 font-black uppercase tracking-widest text-xs mt-2 bg-white/45 px-4 py-1.5 rounded-full border border-yellow-500/40 shadow-lg">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all duration-200 border-2 cursor-pointer ${
                  selectedSide === "PLAYER"
                    ...
                    : "bg-white/90 text-slate-650 border-slate-200 hover:border-blue-500/30"
                }`}
              >
                Player (2x)
              </button>
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all duration-200 border-2 cursor-pointer ${
                  selectedSide === "BANKER"
                    ...
                    : "bg-white/90 text-slate-650 border-slate-200 hover:border-red-500/30"
                }`}
              >
                Banker (1.95x)
              </button>
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all duration-200 border-2 cursor-pointer ${
                  selectedSide === "TIE"
                    ...
                    : "bg-white/90 text-slate-650 border-slate-200 hover:border-yellow-500/40"
                }`}
              >
                Tie (9x)
              </button>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl font-black text-xs uppercase tracking-wider transition-all duration-200 border-2 cursor-pointer ${
                  selectedSide === "PLAYER"
                    ...
                    : "bg-white/90 text-slate-650 border-slate-200 hover:border-emerald-500/30"
                }`}
              >
                Player (2x)
              </button>
