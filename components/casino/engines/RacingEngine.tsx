      ...
      <AnimatePresence>
        {unlocked && (
          <motion.div 
            ...
            className="absolute top-4 left-1/2 -translate-x-1/2 z-40 bg-black/80 backdrop-blur-md border border-emerald-500/50 px-6 py-2 rounded-full pointer-events-none shadow-[0_0_20px_rgba(16,185,129,0.3)]"
          >
