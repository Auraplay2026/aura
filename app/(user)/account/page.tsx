  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <motion.div 
        ...
        className="relative bg-slate-900 border border-slate-800 rounded-[2rem] p-8 overflow-hidden"
      >
        {/* Abstract Background */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="relative group cursor-pointer shrink-0">
            ...
            <div className="absolute -bottom-2 -right-2 bg-slate-900 border border-slate-800 rounded-xl p-2 shadow-xl">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm font-bold">
              {currentUser?.kycStatus === 'APPROVED' ? (
                ...
                <span className="flex items-center gap-1.5 text-slate-400 bg-slate-500/10 px-3 py-1 rounded-full border border-slate-700">
          ...
          <div className="flex gap-6 shrink-0 mt-6 md:mt-0">
            <div className="text-center md:text-right">
              ...
              <p className="text-3xl font-black text-white font-mono tracking-tight">₹{netWorth.toLocaleString(undefined, { maximumFractionDigits: 0 })}</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Available Balance", value: `₹${balance.toLocaleString(undefined, { maximumFractionDigits: 0 })}`, icon: Wallet, color: "text-white" },
          { label: "Active Positions", value: positions.length.toString(), icon: Activity, color: "text-neon-green" },
          { label: "Total Deposits", value: `₹${totalDeposits.toLocaleString()}`, icon: ArrowRight, color: "text-slate-300" },
          { label: "Total Withdrawals", value: `₹${totalWithdrawals.toLocaleString()}`, icon: ShieldCheck, color: "text-slate-300" },
        ].map((stat, i) => (
          <motion.div 
            key={stat.label}
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}
            className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-5 backdrop-blur-xl relative overflow-hidden group"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <motion.div 
            ...
            className="bg-slate-900/60 border border-slate-800 rounded-[2rem] p-8 backdrop-blur-2xl relative overflow-hidden"
          >
            ...
            {saveError && (
              <div className="mb-6 bg-red-500/10 border border-red-500/30 text-red-400 rounded-xl p-4 flex items-center gap-3 text-sm font-bold animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative z-10">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-black/30 border border-slate-800 rounded-xl px-4 py-3.5 text-white font-bold focus:outline-none focus:border-neon-purple transition-colors shadow-inner"
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    readOnly
                    className="w-full bg-black/50 border border-slate-800/50 rounded-xl px-4 py-3.5 text-slate-500 font-bold focus:outline-none cursor-not-allowed"
                  />
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-black/30 border border-slate-800 rounded-xl px-4 py-3.5 text-white font-bold focus:outline-none focus:border-neon-purple transition-colors shadow-inner font-mono"
                  />
          ...
          <motion.div 
            ...
            className="bg-slate-900/60 border border-slate-800 rounded-[2rem] p-8 backdrop-blur-2xl"
          >
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 bg-black/40 border border-slate-800 rounded-2xl group hover:border-slate-700 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 bg-black/40 border border-slate-800 rounded-2xl group hover:border-slate-700 transition-colors">
                ...
                <button className="text-xs font-black uppercase tracking-widest text-slate-400 border border-slate-700 px-5 py-2.5 rounded-lg hover:text-white hover:border-slate-500 transition-colors w-full sm:w-auto">Manage</button>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 relative z-10">
              <div className="bg-black/40 border border-neon-green/30 rounded-2xl p-5 relative overflow-hidden shadow-[0_0_15px_rgba(34,197,94,0.1)]">
                <div className="absolute top-0 right-0 w-16 h-16 bg-neon-green/10 rounded-bl-full" />
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-white font-black">Level 1 (Basic)</span>
              ...
              <div className="bg-black/20 border border-slate-800 border-dashed rounded-2xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-slate-300 font-bold">Level 2 (Advanced)</span>
                  <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest px-2 py-0.5 rounded bg-slate-800">Pending</span>
                </div>
                ...
                <button className="w-full py-3 rounded-xl bg-slate-800 text-xs font-black text-white uppercase tracking-widest hover:bg-slate-700 transition-colors border border-slate-700">
                  Begin KYC Process
                </button>
              </div>
            </div>
          ...
          {currentUser?.role === 'admin' && (
            <motion.div 
              ...
              className="bg-slate-900/60 border border-yellow-500/30 rounded-[2rem] p-8 backdrop-blur-2xl relative overflow-hidden"
            >
              <div className="absolute -left-32 top-0 w-64 h-64 bg-yellow-500/5 blur-[80px] rounded-full pointer-events-none" />
              
              <h2 className="text-xl font-black text-white flex items-center gap-3 mb-6 relative z-10">
              ...
              <p className="text-xs text-slate-400 mb-6 relative z-10 leading-relaxed font-semibold">
              ...
              <div className="flex flex-col gap-3 relative z-10">
                ...
                <Link 
                  ...
                  className="bg-slate-800 hover:bg-slate-750 text-white border border-slate-700 font-black py-3 px-4 rounded-xl text-center text-xs uppercase tracking-wider transition-all hover:scale-105 active:scale-95"
                >
                  Live RTP Monitor
                </Link>
              </div>
