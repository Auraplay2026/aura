          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-4">
              <div>
                ...
                <h3 className="text-lg font-black tracking-tight mt-1 text-white">Weekly Betradar Guides</h3>
                ...
                {!newsletterSubscribed ? (
                  ...
                  >
                    <input 
                      ...
                      className="px-4 py-3 bg-white/10 border border-white/10 hover:border-white/20 focus:border-red-600 focus:outline-none transition-all rounded-xl text-xs font-semibold text-white placeholder-slate-400"
                    />
                    <button 
                      type="submit"
